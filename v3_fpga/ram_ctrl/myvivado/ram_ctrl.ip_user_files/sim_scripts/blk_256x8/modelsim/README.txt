...
#
# Generated by export_simulation on Tue Jul 16 18:48:02 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './blk_256x8.sh' script.

./blk_256x8.sh -reset_run
...
./blk_256x8.sh -noclean_files

For more information on the script, please type './blk_256x8.sh -help'.
