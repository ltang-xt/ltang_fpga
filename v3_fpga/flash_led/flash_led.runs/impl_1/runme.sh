...
HD_PWD='D:/work/github/ltang_fpga/v3_fpga/flash_led/flash_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_flash_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_flash_led.tcl -notrace
