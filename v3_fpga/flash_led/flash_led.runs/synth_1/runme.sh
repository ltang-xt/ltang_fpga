...
HD_PWD='D:/work/github/ltang_fpga/v3_fpga/flash_led/flash_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_flash_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_flash_led.tcl
